...
const Home: React.FC<Props> = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string) => (
        <div className="cursor-pointer">
          <a href={text} target="_blank" rel="noopener noreferrer" className="link">
            {text}
          </a>
        </div>
      )
    },
    {
      ...
      dataIndex: 'publisher',
      width: '15%',
      render: (publisher: IPublisher) => <span>{publisher.name}</span>
    },
    {
      title: 'Languages',
      dataIndex: 'languages',
      ...
      render: (_: any, newspaper: INewspaper) => (
        <Space size="middle">
          <Dropdown
            ...
            overlay={
              <Menu>
                <Menu.Item key="view" onClick={() => viewNewspaper(newspaper)}>
                  View Newspaper
                </Menu.Item>
                <Menu.Item key="edit" onClick={() => editNewspaper(newspaper)}>
                  Edit Newspaper
                </Menu.Item>
                <Menu.Item key="delete" onClick={() => showDeleteNewspaper(newspaper)}>
                  Delete Newspaper
                </Menu.Item>
              </Menu>
            }
  ...
  return (
    <>
      <div className="home">
        <h1 className="title">Newspaper</h1>
